...
{
    public class MTEBatch : BatchBase
    {
        ...
        public override void ProcessAddenda(string line, ACHFile achFile, int lineNumber)
        {
            if (achFile.CurrentBatch != null)
            {
                if (achFile.CurrentBatch.EntryRecord != null)
                {
                    ...
                    {
                        var ad = new Addenda();
                        var adCount = lastEntry.AddendaRecord.Count;
                        if (adCount > 1)
                        {
                        ...
                        else
                        {
                            ...
                            switch (typeCode)
                            {
                                case AddendaTypeCode.Addenda02:
                                    ...
                                    ad.TransDescription = line.Substring(3, 10).Trim();
                                    ad.NetworkIdCode = line.Substring(10, 3).Trim();
                                    ...
                                    ad.TransTime = line.Substring(29, 6).Trim();
